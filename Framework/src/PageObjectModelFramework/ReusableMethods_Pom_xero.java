...
public class ReusableMethods_Pom_xero extends DriverScript_Pom_xero  {
	...
	static int c=1;
		...
		public static void actions_enterText(WebElement webObj, String textVal, String objName ) throws IOException{
			if(webObj.isEnabled()){
				Actions act=new Actions(driver);
				act.moveToElement(webObj).click();
				act.sendKeys(textVal).build().perform();
				Update_Report("Pass", "enterText", textVal + "  entered in " + objName+" field");
		...
		public static void validate_page(String expected) throws IOException{
			...
			if(title.contains(expected))
			{
				String actual = driver.getCurrentUrl();
					...
					Update_Report("Pass", "Page Launch", title+" is matching to "+expected);
				}else
				{
					Update_Report("Fail","Page Launch", title+" is Not matching to "+expected);
				}
		...
		public static void validate_errormsg(WebElement Webobj,String expected) throws IOException
		{
			if(Webobj.isDisplayed())
			{
				String actual = Webobj.getText().trim();
